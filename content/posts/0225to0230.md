...
&emsp;field 	n.田地田野， 也可以表示领域，计科中翻译成“字段”或者“域”

&emsp;sleeping bag 睡袋，doing表示功能用途，如 a swimming pool，a waiting room

&emsp;soundly  adv.状况良好的

&emsp;wind 	v.蜿蜒，弯曲

&emsp;in the middle of 和 in the center of 的区别

&emsp;&emsp;in the center of: 后面只能接地点

&emsp;&emsp;in the middle of: 除了加地点，还可以加时间，in the middle of the night

&emsp;by的用法，到目前为止讲解了三种：

&emsp;&emsp;1、by train：表示方式方法

&emsp;&emsp;2、被动语态 + by：强调动作的发出者

&emsp;&emsp;3、by the campfire：表示在旁边
...
&emsp;&emsp;1、begin/began to do.   it begin to rain

&emsp;&emsp;2、 begin/began doing ， it begin raining

&emsp;本节出现的长句：

&emsp;&emsp;It wan raining heavily `and` they found `that` a stream had formed in the field.

&emsp;&emsp;可以通过找出连接词拆解
...
ancient	adj. 古代的 古老的		ancient myth 古代的神话

have trouble in doing sth. 	某件事情做起来有麻烦

&emsp;have trouble in speaking English
